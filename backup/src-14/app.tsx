...
export function App() {
  ...
  async function holeMieter() {
    try {
      ...
      // Verwenden Sie den Anonymous-Key aus Ihrer Supabase-Konfiguration
      const anonKey = import.meta.env.VITE_SUPABASE_ANON_KEY; // Stellen Sie sicher, dass dies in Ihrer .env-Datei definiert ist
      if (!anonKey) {
